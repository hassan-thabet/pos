...
import 'package:uptime_code/main.dart';
...
class UpdateItem extends StatelessWidget {
  ...
  final Map item;
  const UpdateItem({Key? key, required this.groups, required this.item}) : super(key: key);
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    async {
                      ...
                      try{
                        DatabaseHelper().updateItem(groupId, code, price, stock, item['id'], itemName, imageUrl);
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('$itemName $code ') , backgroundColor: Colors.green[800],)
                      );
                    },
